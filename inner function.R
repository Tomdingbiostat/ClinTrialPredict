...
integral.s2 <- function(s,m,l,alpha,nu,gamma){
  integral2(function(a,t){1/s * dweibull(t,shape=alpha,scale=nu) * (1-pexp(t,rate=gamma))},0,l-m,0,function(x) l-x)$Q +
...
integral.s5 <- function(s,m,l,alpha,nu,gamma){
  integral2(function(a,t){1/s * dweibull(t,shape=alpha,scale=nu) * (1-pexp(t,rate=gamma))},0,s,0 ,m)$Q
}
