...
TrialPred.TwoArm(N.0=200,N.1=200,alpha0.t = 1.2,nu0.t=20,HR=1.2,l=5,s=12,m=18,d=8)

TrialPred.TwoArm(N.0=200,N.1=200,alpha0.t = 0.8,nu0.t=20,HR=0.8,l=8,s=12,m=6,d=8)
